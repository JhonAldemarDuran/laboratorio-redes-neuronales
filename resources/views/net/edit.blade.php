            ...
            <div class="card-content">
                ...
                action = "{{route('user.plant.net.update', ['user' => auth()->user()->id,'plant'=>$plant,'net'=>$net])}}">
                    ...
                    <div class="input-field col s4">
                        <input id="delta" name = "delta" type="number" step="0.00001" class="validate" value="{{$net->delta}}">
                  ...
                  <div class="input-field col s4">
                        <input id="rate_learning" name = "rate_learning" step="0.00001" type="number" class="validate" value="{{$net->rate_learning}}">
                    ...
                    <div class="input-field col s4">
                        <input id="itera" name = "itera" type="number" class="validate" value="{{$net->itera}}">
                    ...
                    <div class="input-field col s4">
                        <input id="numero_capas" name = "numero_capas" type="number" class="validate" value="{{$net->numero_capas}}">
                    ...
                    <div class="input-field col s4">
                        <input id="numero_neu" name = "numero_neu" type="number" class="validate" value="{{$net->numero_neu}}">
                    ...
                    <div class="input-field col s4">
                        <input id="tiempo_establecimiento" name = "tiempo_establecimiento" step="0.00001" type="number" class="validate" value="{{$net->tiempo_establecimiento}}">
                    ...
                    <div class="input-field col s4">
                        <input id="tiempo_muestreo" name = "tiempo_muestreo" type="number" step="0.00001" class="validate" value="{{$net->tiempo_muestreo}}">
                    ...
                    <div class="input-field col s4">
                        <input id="instancias_adq" name = "instancias_adq" type="number" class="validate" value="{{$net->instancias_adq}}">
                    ...
                    <div class="input-field col s4">
                        <input id="instancias_c" name = "instancias_c" type="number" class="validate" value="{{$net->instancias_c}}">
                    ...
                    <div class="col s6">
                        ...
                        <div class="input-field col s3">
                            <input id="a11" name = "a11" type="number" class="validate" value="{{$net->a11}}">
                        ...
                        <div class="input-field col s3">
                            <input id="a12" name = "a12" type="number" class="validate" value="{{$net->a12}}">
                        ...
                        <div class="input-field col s3">
                            <input id="a21" name = "a21" type="number" class="validate" value="{{$net->a21}}">
                        ...
                        <div class="input-field col s3">     
                            <input id="a22" name = "a22" type="number" class="validate" value="{{$net->a22}}">
                    ...
                    <div class="col s6">
                        ...
                        <div class="input-field col s4">
                            <input id="b11" name = "b11" type="number" class="validate" value="{{$net->b11}}">
                        ...
                        <div class="input-field col s4">
                            <input id="b21" name = "b21" type="number" class="validate" value="{{$net->b21}}">
                        ...
                        <div class="input-field col s4">
                            <input id="b22" name = "b22" type="number" class="validate" value="{{$net->b22}}">
                     ...
                     <div class="col s6"> 
                        ...
                        <div class="input-field col s4">
                            <input id="c11" name = "c11" type="number" class="validate" value="{{$net->c11}}">
                        ...
                        <div class="input-field col s4">
                            <input id="c12" name = "c12" type="number" class="validate" value="{{$net->c12}}">
                    ...
                    <div class="col s6"> 
                        ...
                        <div class="input-field col s4">
                            <input id="d11" name = "d11" type="number" class="validate" value="{{$net->d11}}">
