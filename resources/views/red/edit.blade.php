...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Editar Red ({{ $data->name }})</li>
  </ol>
</nav>
    ...
    <div class="col-12 col-md-8 col-lg-10">
        ...
        <div class="card" >
             <div class="card-header">
                 <h1 class="card-title">Editar red</h1>
                <a class="card-subtitle mb-2 text-muted" href="{{ route('reportes.index') }}">
         ...
         {{--   <div class="form-group">
            ...
            <div class="form-group">
                 ...
                 {!!Form::label('numero_neu','Número de Neuronas',['class'=>'control-label']) !!}
                 {!!Form::text('numero_neu',null,['class'=>'form-control']) !!}
            ...
            {!! Form::submit('Actualizar red', ['class' => 'btn btn-outline-primary']) !!}
            {!! Form::close() !!}
